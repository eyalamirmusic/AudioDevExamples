...
/*
  A little helper class to simplify creating a new list, caching it and saving it
  to a parameter layout.
...
public:
    ...
    //Similar to add(), but also copies the value used for parameterID
